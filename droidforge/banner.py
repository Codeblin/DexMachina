"""ASCII art banner and terminal theme for DroidForge."""
...
def banner_enabled() -> bool:
    val = os.environ.get("DROIDFORGE_NO_BANNER", "").lower()
...
def render_banner(*, compact: bool = False, version: str = __version__) -> RenderableType:
    ...
    stack = Group(
        Panel(
            ...
            padding=(1, 2),
            title="[bold bright_green]⚡ DROIDFORGE ⚡[/]",
            title_align="center",
            subtitle=TAGLINE,
